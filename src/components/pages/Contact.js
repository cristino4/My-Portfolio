...
const Contact = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <p className="font-sans text-lg font-bold text-center w-2/3 m-10">Submit the form below to contact me through e-mail, or you may call me at my direct line below.</p>
            <div className="flex flex-col">
                <div className="flex flex-row items-center flex-wrap m-4 p-2 justify-center">
                    ...
                    <form className="flex flex-col border rounded-md" onSubmit={(e) => {formSumbitHandler(e)}}>
                        ...
                        <textarea type="text" name="message" id="message" className="resize-none p-1 m-3" required maxLength="500" rows="6" cols="50"/>
