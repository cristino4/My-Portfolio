    ...
    return (
            <div className="hero flex flex-col w-full">
                ...
                <div className="text-white">
                    ...
                    <p className="font-sans py-6">I'm an electrical engineer and software developer from Anaheim, California. <br></br><br></br>
                    ...
                    <br></br><br></br>
                    Today, I add web development to my many skills and am currently looking for a full-time position as a software or electronics engineer.
